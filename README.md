    ...
    <script>
        $(document).ready(function(){
            ...
            $("#ocultar").hover(function(){
                $("#dinamico").show();
                $('#ocultar').css( 'cursor', 'pointer' );
            });


            $("#cssborde").hover(function(){
                $("#dinamico").show();
                $('#cssborde').css( 'cursor', 'pointer' );
            });
            ...
            $("#cssborde").click(function(){
                ...
                $("#dinamico").css("border","2px  double yellow", "cursor", "pointer");
            });
            $("#cssborde").hover(function(){
...
<p>Segundo texto con etiqueta p</p>
...
<input type="button" value="Calcular la suma" id="sumarnumeros">
<p id="resultado"></p>
